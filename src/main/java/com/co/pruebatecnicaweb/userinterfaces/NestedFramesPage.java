...
public class NestedFramesPage {
    ...
    public static final Target BODY = Target.the("Body of the page").located(By.xpath("//body"));
    public static final By FRAME_CHILD = By.xpath( "//iframe[@srcdoc='<p>Child Iframe</p>']");
    public static final Target BODY_CHILD = Target.the("Body of the page").located(By.xpath("//body//p"));
}
